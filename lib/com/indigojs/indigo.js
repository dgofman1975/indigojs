...
var Indigo = com.indigojs.Indigo = {
    inner: {
        instances: {},
        /*DEBUG*/ count: 0, //Number function calls
        ...
        property: function(inst, name, defaultValue, setter, getter, visible) {
            ...
            if (getter === true || getter instanceof Function)
                o.get = function () {
                    ...
                    /*DEBUG*/Indigo.propHook(false, this, name, value);
                    return value;
                };
            if (setter === true || setter instanceof Function)
                o.set = function (value) {
                    ...
                    /*DEBUG*/Indigo.propHook(true, this, name, val, newValue);
                    val = newValue;
                };
    ...
    /*DEBUG*/propHook: function(isSet, inst, propName, value, newValue, count) {}
};
