        ...
        shim: function(o, _) {
            var apis = {
                ...
                width: function(value) {
                    return undef(value) ? parseInt(apis.css('width'), 10) || o.getBoundingClientRect().right : !(o.style.width = value) || _;
                },
                height: function(value) {
                    return undef(value) ? parseInt(apis.css('height'), 10) || o.getBoundingClientRect().bottom : !(o.style.height = value) || _;
                },
                css: function(value) {
