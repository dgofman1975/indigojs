...
register('impl.d3.IWidget', {
    static: {
        ...
        find: function(selector, parent, ref) {
            ...
            var all = selector instanceof Array ? selector :
                      selector instanceof Element ? d3.select(selector) : (parent || d3).selectAll(selector);
        ...
        shim: function(all, _) {
            ...
            var apis = {
                ...
                parent: function() {
                    return IWidget.find(o.node().parentNode);
                },
